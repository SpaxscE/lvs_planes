...
ENT.StallVelocity = 150 -- forward velocity in which the plane will start to stall. This can be a negative number aswell. !!should never be above ENT.MaxPerfVelocity and rule of thumb be about 1/12th of ENT.MaxPerfVelocity!!
...
ENT.StallForceMax = 15 -- clamps the gravitational rotating-force on stall. 
